    ...
    generateBlog(data) {
        ...
        for(let i in data.blogs) {
            ...
            html += `<div class="single-blog">
                        <div class="blog-img">
                            <a href="${blog._links[LOCALE]}"><img src="${ blog.media.images[0].file }" alt="${ blog.title }"></a>
                        ...
                        <div class="blog-content">
                            <a class="blog-title" href="${blog._links[LOCALE]}">${ trans.title }</a>
                            <p class="blog-text">${ trans.short_description }</p>
                            <a class="blog-read-more letter-capitalize" href="${blog._links[LOCALE]}">${Translator.trans('read_more', null, 'messages', LOCALE)}</a>
                        </div>
                    </div>`;
        }
