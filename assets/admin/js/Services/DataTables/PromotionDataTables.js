    ...
    init()
    {
        ...
        const tableOptions = {
            ...
            columns: [
                ...
                { data: `option_${PROMOTION_OPTIONS.OPTION_HOME_SCREEN_BAR}`, orderable: false, name: `option_${PROMOTION_OPTIONS.OPTION_HOME_SCREEN_BAR}`, title: 'Početna stranica bar', render: function (data, type){
                        return data === true ? 'Da' : 'Ne';
                    }},
