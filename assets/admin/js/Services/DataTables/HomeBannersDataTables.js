...
class HomeBannersDataTables {
    ...
    init()
    {
        const route = Routing.generate('admin.get_home_banner_list');
...
const homeBannersDataTables = new HomeBannersDataTables();

export default homeBannersDataTables;
